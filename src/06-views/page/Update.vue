      ...
      <el-tabs type="border-card">
        <el-tab-pane label="基本信息">
          <div class="content">
            ...
            <el-form-item class="" label="状态" prop="pageStatus">
...
<script>
import { updatePage, getPage } from "@/03-api/page";
...
export default {
  ...
  computed: {},
  created() {
    this.init(this.$route.query.pageId);
  },
  methods: {
    async init(id) {
    ...
    async onSubmit() {
      try {
        ...
        if (await this.$refs.form.validate()) {
          ...
          const { code } = await updatePage(param, { isAction: true });
          if (code == 0) {
